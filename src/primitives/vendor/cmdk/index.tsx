// Vendored from cmdk (c) 2022 Paco Coursey, MIT. See vendor/LICENSE.cmdk.
// Local modification: Radix imports resolve to the pinned local source.
'use client'

import * as RadixDialog from '../radix/react-dialog'
import * as React from 'react'
import { commandScore } from './command-score'
import { Primitive } from '../radix/react-primitive'
import { useId } from '../radix/react-id'
import { composeRefs } from '../radix/react-compose-refs'
  ...
  useLayoutEffect(() => {
    const value = (() => {
      for (const part of deps) {
        ...
        if (part !== null && typeof part === 'object' && 'current' in part) {
          if (part.current) {
